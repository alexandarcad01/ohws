...
in columnmodifyvalue varchar(90),
in columnname1 varchar(50),
in columnmodifyvalue1 varchar(90),
in columnname2 varchar(50),
in columnmodifyvalue2 varchar(90),
in conditioncolumnname varchar(90),
in conditioncheckvalue int
) 
begin

set @updatestatement = Concat('update ',tablename,' set ', columnname ,'=\'',columnmodifyvalue,'\',', columnname1 ,'=\'',columnmodifyvalue1,'\' where ',conditioncolumnname,'=',conditioncheckvalue);
...
call update_users_reg('ohws_user_reg','Account_type','paid','sno',5);
